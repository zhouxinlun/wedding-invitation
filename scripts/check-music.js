...
function setup(webFile,{autoStart=true}={}){
  ...
  w.eval(autoStart?source:source.replace("  start({detail:{automatic:true}});\n",''));
...
(async()=>{
  ...
  const late=setup('media/recording.mp3',{autoStart:false});try{
